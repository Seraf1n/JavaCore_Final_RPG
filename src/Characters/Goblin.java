...
public class Goblin extends Character implements Fighter {
    ...
    Goblin(String name, int lvl, int gold, int exp) {
        super(name, lvl, gold, exp);
    }

    public static Character createGoblin(int lvlPlayer) {
        ...
        return new Goblin("Goblin_lvl"+monsterLvl, monsterLvl, gold, exp);
    }
